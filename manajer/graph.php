...
$databarang = mysqli_query($koneksi,$query);
				$query="SELECT * FROM category";
$datakategori = mysqli_query($koneksi,$query);
				$counter=10;
...
<script type="text/javascript" src="<?=BASEURL;?>/olshop/js/jquery.canvasjs.min.js"></script>
